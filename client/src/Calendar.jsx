      ...
      {showEventForm && (
        <div className={`event-modal ${showEventForm ? 'show' : ''}`}>
          ...
          <form className="event-form">
            ...
            <input type="text" name="EstadoExamen" value={selectedEvent?.EstadoExamen || newEvent.EstadoExamen} onChange={(e) => setSelectedEvent({ ...selectedEvent, EstadoExamen: e.target.value })} />
      ...
      {showEdicion && (
        <div className={`event-modal ${showEdicion ? 'show' : ''}`}>
          ...
          <form className="event-form">
            ...
            <label>Estado del Examen:</label>
            <input type="text" name="EstadoExamen" value={selectedEdit?.EstadoExamen || newEvent.EstadoExamen} onChange={(e) => setselectedEdit({ ...selectedEdit, EstadoExamen: e.target.value })} />
            <div className="button-container">
      ...
      {showEditForm && (
        <div className={`event-details-container ${showEditForm ? 'show' : ''}`}>
          <div className="event-details">
            ...
            <p>Estado del Examen: {editFormEvent?.EstadoExamen === "0" ? "Pendiente" : "Completado"}</p>
            <div className='button-container'>
